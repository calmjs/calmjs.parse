# -*- coding: utf-8 -*-
"""
ES2015 (ECMAScript Edition 6/ES6) parser.
"""
...
# XXX this is still the es5 version
...
class Parser(object):
    """ECMAScript 2015 parser (ECMA-262 6th edition grammar).
    ...
    def p_program(self, p):
        ...
        p[0] = self.asttypes.ES2015Program(p[1])
    ...
    # For the evaluation of Object Initialisere as described in 12.2.6
    # and property accessors as described in 12.3.2, the IdentifierName
    ...
    # 12.3.2; same for the further cases.
    ...
    def p_expr_statement(self, p):
        """expr_statement : expr_nobf SEMI
                          | expr_nobf AUTOSEMI
        """
        # In 13.5, expression statements cannot start with either the
...
def parse(source, with_comments=False):
    """
    Return an AST from the input ES2015 source.
    """
