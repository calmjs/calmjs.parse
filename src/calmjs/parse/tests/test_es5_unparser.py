...
class OtherUsageTestCase(unittest.TestCase):
    ...
    def test_minify_print_obfuscate_skip_keywords(self):
        ...
        # Note that these identifiers can be easily generated by
        # iterating through an instance of the obfuscation.NameGenerator
        # class
...
MinfyPrintTestCase = build_equality_testcase(
    'MinfyPrintTestCase', partial(minify_print, obfuscate=True), ((
        label,
