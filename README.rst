...
.. image:: https://travis-ci.org/calmjs/calmjs.parse.svg?branch=1.1.3
    :target: https://travis-ci.org/calmjs/calmjs.parse
.. image:: https://ci.appveyor.com/api/projects/status/5dj8dnu9gmj02msu/branch/1.1.3?svg=true
    :target: https://ci.appveyor.com/project/metatoaster/calmjs-parse/branch/1.1.3
.. image:: https://coveralls.io/repos/github/calmjs/calmjs.parse/badge.svg?branch=1.1.3
    :target: https://coveralls.io/github/calmjs/calmjs.parse?branch=1.1.3
